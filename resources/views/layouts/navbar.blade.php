<div class="page">
    <!-- Sidebar -->
    <aside class="navbar navbar-vertical navbar-expand-lg navbar-success" data-bs-theme="dark" style="background-color: #304D30">
        ...
        <div class="container-xl">
          <div class="row g-2 align-items-center">
            ...
            <div class="col-auto ms-auto d-print-none">
              <div class="btn-list">
                <a href="/logoutAdmin" class="btn btn-danger d-none d-sm-inline-block">
                  Logout
                </a>
